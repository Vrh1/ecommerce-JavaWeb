    ...
    <body id="page-top">
        ...
        <section class="page-section" id="cadastrar">
            <div class="container">
                ...
                ${ usuario.nome } <!-- valor da variavel java -->
                    ...
                    <div class="row justify-content-md-center mb-5 text-center">
                        <div class="col-md-12 align-self-center text-center">
                            <div class="form-group input-login mx-auto">
                                <input name="usuario.nome" value="${ usuario.getNome() }" minlength="3" maxlength="50" class="form-control" id="email" type="text" placeholder="Nome *" required="required" data-validation-required-message="Please enter your email address." />
                            ...
                            <div class="form-group input-login mx-auto">
                                <input name="usuario.senha" value="${ confirmaSenha }" minlength="6" maxlength="20" class="form-control" id="phone" type="password" placeholder="Repita Senha *" required="required" data-validation-required-message="Insira sua senha." />
                                <p class="help-block text-danger"></p>
                            </div>
